...
class Gac{
	...
	public function Gac($text, closure $function)
	{
		$this->cmp = $function;
		$this->text = $text;
	...
	private function populate($genes)
	{
		...
		die(var_dump($new_genes));
		#array_unique($new_genes);
		usort($new_genes, $this->cmp);
		return $new_genes;
	}
